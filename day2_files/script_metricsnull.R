setwd("C:\\Massol\\Enseignement\\Formation r�seaux\\Formation EcoNet 2025")
rm(list=ls())
...
#food web from Cruz-Escalona, V. H., Arregu�n-S�nchez, F. & Zetina-Rej�n, M. (2007) Analysis of the ecosystem structure of Laguna Alvarado, western Gulf of Mexico, by means of a mass balance model. Estuarine, Coastal and Shelf Science, 72, 155-167.
...
### node specialization/generalism from Bl�thgen's index
dfun(mat_plantpol)
